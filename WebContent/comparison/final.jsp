                                    ...
                                    <form class="layui-form" action="" lay-filter="salary-info">
                                        <div class="input-item layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="number" name="sumsalary" lay-verify="required"
                                                    placeholder="按年填写" autocomplete="off" class="layui-input">
                                                <label class="yuan-label">元</label>
                                            </div>
                                            <label class="input-label layui-form-label"
                                                style="font-size: 10px;">每月工资不同，请尝试：</label>
                                            <button data-method="salary" data-type="auto" type="button"
                                                class="layui-btn layui-btn-primary layui-btn-xs"
                                                style="margin-top: 8px; margin-left:-10px;" id="salary">分月记录</button>
                                        </div>
                                        <div class="input-item layui-form-item">
                                            <label class="input-label layui-form-label">社保个人缴纳额</label>
                                            <div class="layui-input-block">
                                                <input type="number" name="insurance" lay-verify="required"
                                                    placeholder="按年填写" autocomplete="off" class="layui-input">
                                                <label class="yuan-label">元</label>
                                            </div>
                                            <label class="input-label layui-form-label"
                                        ...
                                        <div class="input-item layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="number" name="special" lay-verify="required"
                                                    placeholder="按年填写" autocomplete="off" class="layui-input">
                                                <label class="yuan-label">元</label>
                                            </div>
                                        </div>
                                ...
                                <div class="in-box">
                                    <form class="layui-form" action="" lay-filter="other-info">
                                        <div class="input-item layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="number" name="labour" placeholder="" autocomplete="off"
                                                    class="layui-input">
                                                <label class="yuan-label">元</label>
                                            </div>
                                            <label class="input-label layui-form-label"
                                        ...
                                        <div class="input-item layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="number" name="author" placeholder="" autocomplete="off"
                                                    class="layui-input">
                                                <label class="yuan-label">元</label>
                                            </div>
                                            <label class="input-label layui-form-label"
                                        ...
                                        <div class="input-item layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="number" name="right" placeholder="" autocomplete="off"
                                                    class="layui-input">
                                                <label class="yuan-label">元</label>
                                            </div>
                                            <label class="input-label layui-form-label"
    ...
    <script>
        layui.use(['form', 'layer', 'table'], function () {
            ...
            table.render({
                ...
                , cols: [[ //标题栏
                    { field: 'title', title: '' }
                    , { field: 'salary', title: '工资所得' }
                    , { field: 'labour', title: '劳动所得' }
                    , { field: 'author', title: '稿酬所得' }
                    , { field: 'right', title: '特许使用' }
                    , { field: 'sum', title: '合计' }
                ]]
                , data: [{
                    "title": "税前",
            ...
            table.render({
                ...
                , cols: [[ //标题栏
                    { field: 'presum', title: '税前年收入' }
                    , { field: 'taxable', title: '应纳税所得额' }
                    , { field: 'tax', title: '适用税率' }
                    , { field: 'tax_value', title: '纳税额' }
                    , { field: 'aftersum', title: '税后年收入' }
                ]]
                , data: [{
                    "presum": "",
                    "taxable": "",
