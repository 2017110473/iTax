...
<!--
     薪资对比页面
     功能：进行不同方案的薪资对比，展示税前年薪、税后年薪、纳税总额、社保缴纳的情况

     输入: 方案一（税前月薪、年终奖、社保个人缴纳、专项扣除）
          方案二（税前月薪、年终奖、社保个人缴纳、专项扣除）

     输出：两种方案下的税前年薪、税后年薪、纳税总额、社保缴纳

     辅助功能：可根据薪资和城市计算五险一金个人缴纳部分；
              五险一金计算可修改参数
              ...
              <form class=" layui-form" action="" lay-filter="strategy1">
                <div class="input-item layui-form-item">
                  ...
                  <div class="layui-input-block">
                    <input type="number" name="salary1" lay-verify="required" placeholder="按月填写" autocomplete="off"
                      class="layui-input">
                ...
                <div class="input-item layui-form-item">
                  ...
                  <div class="layui-input-block">
                    <input type="number" name="bonus1" lay-verify="required" placeholder="按年填写" autocomplete="off"
                      class="layui-input">
                    <label class="yuan-label">元</label>
                  </div>
                </div>
                <div class="input-item layui-form-item">
                  ...
                  <div class="layui-input-block">
                    <input type="number" name="insurance1" lay-verify="required" placeholder="按月填写" autocomplete="off"
                      class="layui-input">
                    <label class="yuan-label">元</label>
                  </div>
                ...
                <div class="input-item layui-form-item">
                  ...
                  <div class="layui-input-block">
                    <input type="number" name="special1" lay-verify="required" placeholder="按月填写" autocomplete="off"
                      class="layui-input">
                    <label class="yuan-label">元</label>
                  </div>
                </div>
            ...
            <div class="in-box">
              <form class="layui-form" action="" lay-filter="strategy2">
                <div class="input-item layui-form-item">
                  <label class="input-label layui-form-label">税前月薪</label>
                  <div class="layui-input-block">
                    <input type="number" name="salary2" lay-verify="required" placeholder="按月填写" autocomplete="off"
                      class="layui-input">
                    <label class="yuan-label">元</label>
                  </div>
                </div>
                <div class="input-item layui-form-item">
                  <label class="input-label layui-form-label">年终奖金</label>
                  <div class="layui-input-block">
                    <input type="number" name="bonus2" lay-verify="required" placeholder="按年填写" autocomplete="off"
                      class="layui-input">
                    <label class="yuan-label">元</label>
                  </div>
                </div>
                <div class="input-item layui-form-item">
                  <label class="input-label layui-form-label">社会保险</label>
                  <div class="layui-input-block">
                    <input type="number" name="insurance2" lay-verify="required" placeholder="按月填写" autocomplete="off"
                      class="layui-input">
                    <label class="yuan-label">元</label>
                  </div>
                ...
                <div class="input-item layui-form-item">
                  <label class="input-label layui-form-label">专项扣除</label>
                  <div class="layui-input-block">
                    <input type="number" name="special2" lay-verify="required" placeholder="按月填写" autocomplete="off"
                      class="layui-input">
                    <label class="yuan-label">元</label>
                  </div>
                </div>
  ...
  <div class="in-box" id="hidden-area-1" style="padding: 10px;">
    ...
    <form class=" layui-form" action="" lay-filter="ins1">
      ...
      <div class="input-item layui-form-item">
        ...
        <div class="layui-input-block">
          <input type="number" name="pensionRate" placeholder="" autocomplete="off" class="layui-input changeable"
            style="width: 50px; padding-left: 5px; margin-left: 20px;">
          <label class="yuan-label">%</label>
          <input type="number" name="pensionBase" placeholder="" autocomplete="off" class="layui-input changeable"
      ...
      <div class="input-item layui-form-item">
        ...
        <div class="layui-input-block">
          <input type="number" name="unempRate" placeholder="" autocomplete="off" class="layui-input changeable"
            style="width: 50px; padding-left: 5px; margin-left: 20px;">
          <label class="yuan-label">%</label>
          <input type="number" name="unempBase" placeholder="" autocomplete="off" class="layui-input changeable"
            style="width: 80px; padding-left: 5px; margin-left: 20px;">
          <label class="yuan-label">元</label>
        </div>
      </div>
      <div class="input-item layui-form-item">
        ...
        <div class="layui-input-block">
          <input type="number" name="houseRate" placeholder="" autocomplete="off" class="layui-input changeable"
            style="width: 50px; padding-left: 5px; margin-left: 20px;">
          <label class="yuan-label">%</label>
          <input type="number" name="houseBase" placeholder="" autocomplete="off" class="layui-input changeable"
            style="width: 80px; padding-left: 5px; margin-left: 20px;">
          <label class="yuan-label">元</label>
        </div>
      </div>
    ...
    layui.use(['form', 'layer', 'table'], function () {
      ...
      table.render({
        ...
        , cols: [[ //标题栏
          ...
          , { field: 'stg1', title: '方案一', align: 'center' }
          , { field: 'stg2', title: '方案二', align: 'center' }
          , { field: 'best', title: '优选方案', align: 'center' }
        ]]
        , data: [{
          "title": "税前年薪",
          "stg1": "",
        ...
        if (stg1.salary1 == "" || stg1.bonus1 == "" || stg1.insurance1 == "" || stg1.special1 == "" ||
          ...
          table.render({
            ...
            , cols: [[ //标题栏
              ...
              , { field: 'stg1', title: '方案一', align: 'center' }
              , { field: 'stg2', title: '方案二', align: 'center' }
              , { field: 'best', title: '优选方案', align: 'center', style: 'background:#c7e6ff; color:#000;weight:bolder;' }
            ]]
            , data: [{
              "title": "税前年薪",
              "stg1": stg1.pretax_income.toFixed(2), //控制数据为两位小数，下同
              "stg2": stg2.pretax_income.toFixed(2),
              "best": stg1.pretax_income > stg2.pretax_income ? "方案一" : "方案二",
            }, {
              "title": "税后年薪",
              "stg1": stg1.aftertax_income.toFixed(2),
              "stg2": stg2.aftertax_income.toFixed(2),
              "best": stg1.aftertax_income > stg2.aftertax_income ? "方案一" : "方案二",
            }, {
              "title": "纳税总额",
              "stg1": (stg1.tax_salary + stg1.tax_bonus).toFixed(2),
              "stg2": (stg2.tax_salary + stg2.tax_bonus).toFixed(2),
              "best": tax1 > tax2 ? "方案二" : "方案一",
            }, {
              "title": "社保个人缴纳总额",
              "stg1": (parseFloat(form.val('strategy1').insurance1) * 12).toFixed(2),
              "stg2": (parseFloat(form.val('strategy2').insurance2) * 12).toFixed(2),
