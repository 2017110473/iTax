            ...
            <form class="layui-form" action="" lay-filter="info">
              <div class="layui-form-item">
                ...
                <div class="layui-input-block" style="width: 200px; float: left;margin-left: 17px;">
                  <input type="number" name="salary" lay-verify="required|number" placeholder="请输入金额" autocomplete="off"
                    class="layui-input">
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-block" style="width: 200px; float: left;margin-left: 10px;">
                  <input type="text" name="start" autocomplete="off" class="layui-input" value="5000" disabled="">
                  <span class="unit">元</span>
                </div>
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-block" style="width: 200px; float: left;margin-left: 17px;">
                  <input type="number" name="special" lay-verify="required" placeholder="请输入金额" autocomplete="off"
                    class="layui-input">
                  <span class="unit">元</span>
                </div>
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-block" style="width: 200px; float: left;margin-left: 10px;">
                  <input type="text" name="tax" autocomplete="off" class="layui-input" disabled="">
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-block" style="width: 200px;margin-left: 0px;margin-top: -5px; float: left;">
                  <input type="number" name="pensionRate" lay-verify="required" autocomplete="off" class="layui-input"
                    style="width: 50px;height: 25px; margin-left: 18px; padding-left: 5px;">
                  <span class="unit">%</span>
                  <input type="number" name="pensionBase" lay-verify="required" autocomplete="off" class="layui-input"
                ...
                <div class="layui-input-block" style="width: 200px; float: left;margin-left: 10px;">
                  <input type="text" name="tax_value" autocomplete="off" class="layui-input" disabled="">
                  <span class="unit">元</span>
                </div>
              </div>
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-block" style="width: 200px;margin-left: 0px;margin-top: -18px; float: left;">
                  <input type="number" name="medRate" lay-verify="required" autocomplete="off" class="layui-input"
                    style="width: 50px;height: 25px; margin-left: 18px; padding-left: 5px;">
                  <span class="unit">%</span>
                  <input type="number" name="medBase" lay-verify="required" autocomplete="off" class="layui-input"
                    style="width: 70px;;height: 25px; margin-left: 20px; padding-left: 5px;">
                  <span class="unit">元</span>
                </div>
                <label class="layui-form-label" style="margin-left: 58px; ">税后工资：</label>
                <div class="layui-input-block" style="width: 200px; float: left;margin-left: 10px;">
                  <input type="text" name="after_salary" autocomplete="off" class="layui-input" disabled="">
                  <span class="unit">元</span>
                </div>
              </div>
              <div class="layui-form-item" style="margin-top: -20px;">
                ...
                <div class="layui-input-block" style="width: 200px;margin-left: 0px;margin-top: -18px; float: left;">
                  <input type="number" name="unempRate" lay-verify="required" autocomplete="off" class="layui-input"
                    style="width: 50px;height: 25px; margin-left: 18px; padding-left: 5px;">
                  <span class="unit">%</span>
                  <input type="number" name="unempBase" lay-verify="required" autocomplete="off" class="layui-input"
                    style="width: 70px;;height: 25px; margin-left: 20px; padding-left: 5px;">
                  <span class="unit">元</span>
                </div>
              </div>
              <div class="layui-form-item" style="margin-top: -20px;">
                ...
                <div class="layui-input-block" style="width: 200px;margin-left: 0px;margin-top: 5px; float: left;">
                  <input type="number" name="houseRate" lay-verify="required" autocomplete="off" class="layui-input"
                    style="width: 50px;height: 25px; margin-left: 18px;padding-left: 5px;">
                  <span class="unit">%</span>
                  <input type="number" name="houseBase" lay-verify="required" autocomplete="off" class="layui-input"
                    style="width: 70px;;height: 25px; margin-left: 20px; padding-left: 5px;">
                  <span class="unit">元</span>
                </div>
              </div>
    ...
    layui.use('form', function () {
      ...
      function computeTax() {
        ...
        $.ajax({
          ...
          success: function (data) {
            form.val('info', {
              "deduction": Math.round(parseFloat(data.deduction) * 100) / 100,
