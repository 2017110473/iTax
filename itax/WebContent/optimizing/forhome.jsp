...
<body>
              ...
              <form class=" layui-form" action="" lay-filter="info">
                <div class="input-item layui-form-item">
                  ...
                  <div class="layui-input-block">
                    <input type="number" name="my_salary" lay-verify="required" placeholder="按月填写" autocomplete="off"
                      class="layui-input">
                ...
                <div class="input-item layui-form-item">
                  ...
                  <div class="layui-input-block">
                    <input type="number" name="my_ins" lay-verify="required" placeholder="按月填写" autocomplete="off"
                      class="layui-input">
                    <label class="yuan-label">元</label>
                  </div>
                ...
                <div class="input-item layui-form-item">
                  ...
                  <div class="layui-input-block">
                    <input type="number" name="mate_salary" lay-verify="required" placeholder="按月填写" autocomplete="off"
                      class="layui-input">
                    <label class="yuan-label">元</label>
                  </div>
                </div>
                <div class="input-item layui-form-item">
                  ...
                  <div class="layui-input-block">
                    <input type="number" name="mate_ins" lay-verify="required" placeholder="按月填写" autocomplete="off"
                      class="layui-input">
                    <label class="yuan-label">元</label>
                  </div>
              ...
              <form class="layui-form" action="" lay-filter="special">
                <div class="layui-form-item">
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="checkbox" lay-filter="children" name="children" value="children" title="子女教育">
                      <input type="checkbox" lay-filter="house" name="house" value="house" title="住房情况">
                    </div>
                  </div>
                  <div class="layui-form-item">
                    <label class="input-label layui-form-label">个人情况</label>
                    <div class="layui-input-block">
                      <input type="checkbox" lay-filter="theold" name="theold" value="theold" title="赡养老人">
                      <input type="checkbox" lay-filter="education" name="education" value="education" title="继续教育">
                    </div>
                  </div>
                </div>
              </form>
  ...
  <div class="in-box" id="hidden-area-1" style="padding: 10px;">
    ...
    <form class=" layui-form" action="" lay-filter="myins">
      ...
      <div class="input-item layui-form-item">
        ...
        <div class="layui-input-block">
          <input type="number" name="myPensionRate" placeholder="" autocomplete="off" class="layui-input changeable"
            style="width: 50px; padding-left: 5px; margin-left: 20px;">
          <label class="yuan-label">%</label>
          <input type="number" name="myPensionBase" placeholder="" autocomplete="off" class="layui-input changeable"
      ...
      <div class="input-item layui-form-item">
        ...
        <div class="layui-input-block">
          <input type="number" name="myMedRate" placeholder="" autocomplete="off" class="layui-input changeable"
            style="width: 50px; padding-left: 5px; margin-left: 20px;">
          <label class="yuan-label">%</label>
          <input type="number" name="myMedBase" placeholder="" autocomplete="off" class="layui-input changeable"
            style="width: 80px; padding-left: 5px; margin-left: 20px;">
          <label class="yuan-label ">元</label>
        </div>
      </div>
      <div class="input-item layui-form-item">
        ...
        <div class="layui-input-block">
          <input type="number" name="myUnempRate" placeholder="" autocomplete="off" class="layui-input changeable"
            style="width: 50px; padding-left: 5px; margin-left: 20px;">
          <label class="yuan-label">%</label>
          <input type="number" name="myUnempBase" placeholder="" autocomplete="off" class="layui-input changeable"
            style="width: 80px; padding-left: 5px; margin-left: 20px;">
          <label class="yuan-label">元</label>
        </div>
      </div>
      <div class="input-item layui-form-item">
        ...
        <div class="layui-input-block">
          <input type="number" name="myHouseRate" placeholder="" autocomplete="off" class="layui-input changeable"
            style="width: 50px; padding-left: 5px; margin-left: 20px;">
          <label class="yuan-label">%</label>
          <input type="number" name="myHouseBase" placeholder="" autocomplete="off" class="layui-input changeable"
            style="width: 80px; padding-left: 5px; margin-left: 20px;">
          <label class="yuan-label">元</label>
        </div>
      </div>
  ...
  <div class="in-box" id="hidden-area-2" style="padding: 10px;">
    ...
    <form class=" layui-form" action="" lay-filter="mateins">
      ...
      <div class="input-item layui-form-item">
        <label class="input-label layui-form-label">养老</label>
        <div class="layui-input-block">
          <input type="number" name="matePensionRate" placeholder="" autocomplete="off" class="layui-input changeable"
            style="width: 50px; padding-left: 5px; margin-left: 20px;">
          <label class="yuan-label">%</label>
          <input type="number" name="matePensionBase" placeholder="" autocomplete="off" class="layui-input changeable"
            style="width: 80px; padding-left: 5px; margin-left: 20px;">
          <label class="yuan-label">元</label>
        </div>
      </div>
      <div class="input-item layui-form-item">
        <label class="input-label layui-form-label">医疗</label>
        <div class="layui-input-block">
          <input type="number" name="mateMedRate" placeholder="" autocomplete="off" class="layui-input changeable"
            style="width: 50px; padding-left: 5px; margin-left: 20px;">
          <label class="yuan-label">%</label>
          <input type="number" name="mateMedBase" placeholder="" autocomplete="off" class="layui-input changeable"
            style="width: 80px; padding-left: 5px; margin-left: 20px;">
          <label class="yuan-label ">元</label>
        </div>
      </div>
      <div class="input-item layui-form-item">
        <label class="input-label layui-form-label">失业</label>
        <div class="layui-input-block">
          <input type="number" name="mateUnempRate" placeholder="" autocomplete="off" class="layui-input changeable"
            style="width: 50px; padding-left: 5px; margin-left: 20px;">
          <label class="yuan-label">%</label>
          <input type="number" name="mateUnempBase" placeholder="" autocomplete="off" class="layui-input changeable"
            style="width: 80px; padding-left: 5px; margin-left: 20px;">
          <label class="yuan-label">元</label>
        </div>
      </div>
      <div class="input-item layui-form-item">
        <label class="input-label layui-form-label">公积金</label>
        <div class="layui-input-block">
          <input type="number" name="mateHouseRate" placeholder="" autocomplete="off" class="layui-input changeable"
            style="width: 50px; padding-left: 5px; margin-left: 20px;">
          <label class="yuan-label">%</label>
          <input type="number" name="mateHouseBase" placeholder="" autocomplete="off" class="layui-input changeable"
            style="width: 80px; padding-left: 5px; margin-left: 20px;">
          <label class="yuan-label">元</label>
        </div>
      </div>
  ...
  <div class="in-box" id="hidden-area-3" style="padding: 10px;">
    ...
    <form class=" layui-form" action="" lay-filter="parent">
      ...
      <div class="input-item layui-form-item">
        ...
        <label class="input-label layui-form-label" style="font-size: 10px;width: 300px;">1.独生子女不超过2000元/月</label>
        <label class="input-label layui-form-label" style="font-size: 10px;width: 300px;">2.非独生子女计算：2000元/兄弟姐妹个数</label>
      </div>
    </form>
  </div>
  ...
  <div class="in-box" id="hidden-area-4" style="padding: 10px; margin-bottom: 80px; margin-left: 20px;">
    ...
    <form class="layui-form" action="" lay-filter="kids">
      <label class="input-label layui-form-label" style="margin-left: 20px; font-weight: bolder; ">请选择子女个数：</label>
  ...
  <div class="in-box" id="hidden-area-5" style="padding: 10px; margin-left: 50px;">
    ...
    <form class="layui-form" action="" lay-filter="livein">
      <label class="input-label layui-form-label" style="margin-left: 40px; font-weight: bolder; ">请选择住房情况：</label>
      <div>
  ...
  <div class="in-box" id="hidden-area-6" style="padding: 10px;  margin-left: 20px;">
    ...
    <form class="layui-form" action="" lay-filter="study">
      <div class="select-item layui-form-item">
        ...
        <div>
          <input type="checkbox" name="myrecordEducation" value="recordEducation" title="学历教育" lay-skin="primary">
      ...
      <div class="select-item layui-form-item">
        ...
        <div>
          <input type="checkbox" name="materecordEducation" value="recordEducation" title="学历教育" lay-skin="primary">
          <input type="checkbox" name="mateskillEducation" value="skillEducation" title="技能人员职业资格、专业技术人员职业继续教育"
            lay-skin="primary">
        </div>
      </div>
    </form>
    ...
    layui.use(['form', 'layer', 'table'], function () {
      ...
      $('#myinsurance').on('click', function () {
        if (form.val('info').my_salary == "") {
          layer.msg("请填写您的税前月薪");
          return false;
        } else if (parseFloat(form.val('info').my_salary) >= 0) {
      ...
      $('#mateinsurance').on('click', function () {
        if (form.val('info').mate_salary == "") {
          ...
          return false;
        } else if (parseFloat(form.val('info').mate_salary) >= 0) {
          var othis = $(this), method = othis.data('method');
          active[method] ? active[method].call(this, othis) : '';
        } else {
          layer.msg("请填写正确的数据！");
      ...
      form.on('checkbox(children)', function (data) {
        if (form.val('special').children == "children") {
          layer.open({
            ...
            , btnAlign: 'c' //按钮居中
            , yes: function () {
              if (form.val('kids').numberOfKids > 0) {
                layer.closeAll();
              } else {
                form.val('special', {
                  "children": "",
